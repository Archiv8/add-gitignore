...
**_This repository contains unofficial packaging for an installation of [ESLint](https://eslint.org).  It is not affiliated, authorized, endorsed by, or in other way connected with either Arch Linux or the ESLint project._**
